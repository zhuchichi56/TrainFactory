...
cat <<EOL > $output_file
### model
model_name_or_path: /fs-computility/llmit_d/shared/models/Llama-3.1-8B-Instruct
...
### output
output_dir: /fs-computility/llmit_d/shared/liumengjie/LLaMA-Factory/saves/llama3.1-8b/full/sft-${EXEP_NAME}/seed-${SEED}
