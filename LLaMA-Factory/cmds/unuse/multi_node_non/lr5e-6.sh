...
OUTPUT_DIR=/fs-computility/llmit_d/shared/zhuhe/trained_model/saves/${TARGET_MODEL}/full/sft-${DATA_SETTING}/${START_TIME}_CUTOFF_LEN${CUTOFF_LEN}_NNODE${N_NODE}_SEED${SEED}_LR${LEARNING_RATE}
