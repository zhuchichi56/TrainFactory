...
cat <<EOL > $output_file
### model
model_name_or_path: /fs-computility/llmit_d/shared/models/Qwen-2.5-7B-Instruct
...
### output
output_dir: /fs-computility/llmit_d/shared/liumengjie/LLaMA-Factory/saves/qwen2.5-7b/full/sft-${DATA_SETTING}/seed-${SEED}
