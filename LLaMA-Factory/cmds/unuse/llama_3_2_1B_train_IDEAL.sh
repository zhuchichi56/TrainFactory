...
cat <<EOL > $output_file
### model
model_name_or_path: /fs-computility/llmit_d/shared/models/Llama-3.2-1B-Instruct/
...
### output
output_dir: /fs-computility/llmit_d/shared/liumengjie/LLaMA-Factory/saves/llama3.2-1b/full/sft-${EXEP_NAME}/seed-${SEED}
