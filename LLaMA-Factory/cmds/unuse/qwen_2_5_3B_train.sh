...
# 使用完整路径
output_file="${TRAIN_FULL_DIR}/qwen_2_5_full_sft-${DATA_SETTING}_${START_TIME}.yaml"
...
cat <<EOL > $output_file
### model
model_name_or_path: /fs-computility/llmit_d/shared/baitianyi/model/Qwen2.5-3B-Instruct
...
### output
output_dir: /fs-computility/llmit_d/shared/liumengjie/LLaMA-Factory/saves/qwen2.5-3b/full/sft-${DATA_SETTING}/seed-${SEED}
