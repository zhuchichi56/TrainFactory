...
OUTPUT_DIR=/fs-computility/llmit_d/shared/zhuhe/trained_model/saves/${TARGET_MODEL}/full/sft-${DATA_SETTING}/${TARGET_MODEL}_CUTOFF_LEN${CUTOFF_LEN}_LR${LEARNING_RATE}
