...
cat <<EOL > $output_file
### model
model_name_or_path: /fs-computility/llmit_d/shared/models/Qwen/Qwen2.5-1.5B-Instruct
...
### output
output_dir: /fs-computility/llmit_d/shared/liumengjie/LLaMA-Factory/saves/qwen2.5-1b/full/sft-${DATA_SETTING}/seed-${SEED}
