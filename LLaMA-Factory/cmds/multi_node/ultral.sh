...
DEEPSPEED_LEVEL=z3                  # 根据 new_config 更新为 z3
CUTOFF_LEN=2048                     # 根据 new_config 更新为 2048
TEMPLATE=qwen                       # 根据 new_config 更新为 qwen
TARGET_MODEL=Qwen2.5-7B             # 根据 new_config 更新模型名
TOTAL_BATCH_SIZE=128
PER_DEVICE_BATCH_SIZE=4             # 根据 new_config 更新为 4
GRAD_ACCUM_STEPS=$((TOTAL_BATCH_SIZE / (PER_DEVICE_BATCH_SIZE * GPUS_PER_NODE * N_NODE)))
LEARNING_RATE=2.0e-5
OUTPUT_DIR=/fs-computility/llmit_d/shared/zhuhe/trained_model/saves/${TARGET_MODEL}/full/sft-${DATA_SETTING}/${TARGET_MODEL}_CUTOFF_LEN${CUTOFF_LEN}_LR${LEARNING_RATE}_N_NODE${N_NODE}_GBS${TOTAL_BATCH_SIZE}
...
# new_config
# ### model
# model_name_or_path: /nfsdata/laip/model/Qwen/Qwen2___5-7B
# trust_remote_code: true
...
# ### output
# output_dir: /nfsdata/laip/saves/Qwen2___5-7B-sft-ultrachat_200k
# logging_steps: 5
# save_steps: no
# plot_loss: true
# overwrite_output_dir: true
